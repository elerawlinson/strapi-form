...
export interface ApiQuestionQuestion extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    answer_type: Schema.Attribute.Enumeration<
      ['email', 'zip', 'name ', 'multiple-choice', 'phone_number']
    >;
    branchLogic: Schema.Attribute.Text;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Private;
    options: Schema.Attribute.Component<'elements.options', true>;
    publishedAt: Schema.Attribute.DateTime;
    Question_name: Schema.Attribute.String;
    question_type: Schema.Attribute.Enumeration<
      ['text', 'multiple-choice', 'single-choice', 'just-click']
    >;
    questionKey: Schema.Attribute.Integer;
